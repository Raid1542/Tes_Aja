...
session_start(); // Mulai session untuk menangkap notifikasi
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            $ukuran = explode(',', htmlspecialchars($data['ukuran'])); // Pisahkan ukuran berdasarkan koma
                            foreach ($ukuran as $size) {
                            echo "<span>$size</span>"; // Tampilkan tiap ukuran sebagai badge
                            }
                            ?>
                        </td>
